...
class PayrollServiceTest {
    ...
    void applyLatePenalty_CalculatesCorrectly() {
        ...
        BigDecimal initialSalary = new BigDecimal("100.00");
        int lateDays = 2;
        // 2. Act: Llamar a applyLatePenalty(salario, dias)
        BigDecimal result = service.applyLatePenalty(initialSalary, lateDays);
    ...
    void applyLatePenalty_NeverBelowZero() {
        ...
        BigDecimal initialSalary = new BigDecimal("20.00");
        int lateDays = 5;
        // 2. Verificar que el resultado sea 0.00, no un valor negativo.
        assertEquals(new BigDecimal("0.00"), service.applyLatePenalty(initialSalary, lateDays));
    }
}
